	...
	<header>
      ...
      <nav id="nav-wrap">         
         ...
         <ul id="nav" class="nav">
            ...
            <li><a class="smoothscroll" href="#activity">Activity and Engagement</a></li>
            <li><a class="smoothscroll" href="./data_new.php">Content Analytics</a></li>
            <li><a class="smoothscroll" href="#predictive">Predictive Analytics</a></li>
